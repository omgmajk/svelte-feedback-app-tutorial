...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-98ixw4"))) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:6) <Button disabled=\\\"{btnDisabled}\\\" type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 53, 6, 1431);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, message, btnDisabled, text*/ 519) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleSubmit = () => {
    		if (text.trim().length > min) {
    			const newFeedback = { id: v4(), text, rating: +rating };
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 14, 2, 307);
    			attr_dev(button, "class", "close svelte-1laszpa");
    			add_location(button, file$3, 17, 2, 365);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 18, 2, 442);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    // (15:0) {#each $FeedbackStore as fb(fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 15, 2, 505);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:0) {#each $FeedbackStore as fb(fb.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(/*average*/ ctx[0]);
    			add_location(h40, file$1, 8, 2, 235);
    			add_location(h41, file$1, 9, 2, 263);
    			attr_dev(div, "class", "feedback-stats svelte-ga2qn0");
    			add_location(div, file$1, 7, 0, 203);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*count*/ 2) set_data_dev(t0, /*count*/ ctx[1]);
    			if (dirty & /*average*/ 1) set_data_dev(t4, /*average*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $FeedbackStore;
    	validate_store(FeedbackStore, 'FeedbackStore');
    	component_subscribe($$self, FeedbackStore, $$value => $$invalidate(2, $FeedbackStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$inject_state = $$props => {
    		if ('average' in $$props) $$invalidate(0, average = $$props.average);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$FeedbackStore*/ 4) {
    			$$invalidate(1, count = $FeedbackStore.length);
    		}

    		if ($$self.$$.dirty & /*$FeedbackStore*/ 4) {
    			$$invalidate(0, average = $FeedbackStore.reduce((a, { rating }) => a + rating, 0) / $FeedbackStore.length);
    		}
    	};

    	return [average, count, $FeedbackStore];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 7, 0, 209);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

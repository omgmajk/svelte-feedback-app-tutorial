...
var app = (function () {
    ...
    // (42:6) <Button disabled="{btnDisabled}" type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:6) <Button disabled=\\\"{btnDisabled}\\\" type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 44, 6, 1161);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);

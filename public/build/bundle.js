...
var app = (function () {
    ...
    const file$1 = "src\\components\\FeedbackItem.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div0, "class", "num-display svelte-1laszpa");
    			add_location(div0, file$1, 6, 2, 90);
    			attr_dev(div1, "class", "close svelte-1laszpa");
    			add_location(div1, file$1, 9, 2, 148);
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*feedback*/ 1) feedbackitem_changes.item = /*fb*/ ctx[1];
    ...
    class FeedbackList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { feedback: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 23, 0, 630);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ FeedbackList, feedback });
